document.addEventListener("DOMContentLoaded", function(event) {
  ...
  function createNewRow(post, author) {
    ...
    col9.addClass("col-lg-8 col-md-6 col-sm-12 mb-3");
    postTitle.attr("id", "post_Title");
    col1.addClass("col-lg-1 d-none d-sm-none d-md-none d-lg-block");
    i.addClass("fas fa-user-circle");
    col2.addClass("col-lg-3 col-md-6 d-none d-sm-none d-md-block");
    col2.attr("id", "user");
